...
class Plot:
    ...
    def plot(self):
        ...
        # plt.plot(plot_dict['Episodes'], plot_dict['Success Rate'], label="Mean Success Rate")
        # plt.ylabel("Success Rate")
        # plt.xlabel("Episodes")
        # plt.legend()
        # plt.savefig(os.path.join(self.path, 'success_rate'))
        # os.path.join(self.path, plt.savefig('success_rate'))
